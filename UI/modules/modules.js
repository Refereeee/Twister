...
//     } else {
//       return `${TweetFeedView.month[el.createdAt.getMonth()]} ${el.createdAt.getHours()}h.`;
//     }
//   }
//
//   display(tws) {
...
// const tf = new TweetFeedView('#posts__loaded');
// tf.display(tweets);
...
export {HeaderView,TweetFeed,Tweet,Comment,tweets}
